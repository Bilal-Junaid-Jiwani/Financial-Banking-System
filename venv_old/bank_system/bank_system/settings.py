...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^=b%)4#wi1flby%(z(inu-&coh(hkrf#b6__gj#&w8(rtpf&@(')
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'templates')],  # ✅ yeh sahi jagah hai
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
